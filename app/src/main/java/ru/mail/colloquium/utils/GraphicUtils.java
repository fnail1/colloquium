...
import ru.mail.colloquium.utils.photomanager.adapters.FramedDrawable;
...
public class GraphicUtils {
    ...
    public static Rect project(int srcWidth, int srcHeight, int dstWidth, int dstHeight) {
        Rect rect = new Rect();
    ...
    public static Bitmap toBitmap(Drawable drawable) {
        ...
        if (!bounds.isEmpty()) {
            ...
            sw = drawable.getIntrinsicWidth();
            sh = drawable.getIntrinsicHeight();
        }

        return toBitmap(drawable, sw, sh);
    }

    public static Bitmap toBitmap(Drawable drawable, int w, int h) {
